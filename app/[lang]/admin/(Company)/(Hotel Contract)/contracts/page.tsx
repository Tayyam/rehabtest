...
import { useGetContractsQuery } from "@/redux/features/api/company/contracts";
type Props = {};
...
function page({}: Props) {
  ...
  const { data, error, isLoading } = useGetContractsQuery({ paginationPage });
